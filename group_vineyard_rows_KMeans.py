...
def main():
    ply_fle_path = "/home/marko/PycharmProjects/PROJEKT/objects/OG-remove_noise_k=50_s=1-lin_reg_slice_dst=0.1-rotated_2D.ply"#util.get_ply_file_path(util.SLICE_01_INLIERS_K_20_DEV_3_ROTATED)
    ...
    np.savetxt(util.construct_path(util.CLASSIFICATION_FOLDER, "OG-remove_noise_k=50_s=1-lin_reg_slice_dst=0.1-rotated_2D.txt"),
